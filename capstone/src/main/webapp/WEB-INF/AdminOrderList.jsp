  ...
  <li class="nav-item">
    <a class="nav-link" href="/register">Register</a>
			...
			<c:forEach items="${Orders}" var="order">
				...
				<ul>
					<li>Order Status: ${order.getOrderStatus()}</li>
					<li>Order Date: ${order.getOrder_date()}</li>
					<li>Shipping Address: ${order.getSaStreet()}</li>
					<li>${order.getSaCity()}, ${order.getSaState()} ${order.getSaZip()}</li>
				</ul>
				<form method="post">
				<input type="text" hidden name="orderID" value="${order.getOrder_id()}" >
