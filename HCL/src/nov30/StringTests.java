...
class StringTests 
{
		public static void main(String[] args) 
		{
				...
				String s71 = "Welcome to CMC, Ameerpet";

				System.out.println(s71.startsWith("Welcome"));

				System.out.println(s71.endsWith("Ameerpet"));

				System.out.println(s71.startsWith("come", 3));
				...
				String s121 = "This is a test. This is, too.";

				String s13 = s121.concat("Hello.");
				...
				String s151 = "    Hello World     ".trim();

				double d = 20.28;

				System.out.println(String.valueOf(d));
				System.out.println(String.valueOf(s151));
