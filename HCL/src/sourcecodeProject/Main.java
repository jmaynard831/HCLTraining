...
public class Main {
	...
	private static void searchExpenses(ArrayList<Integer> arrayList) {
		...
		if (arrayList.contains(con_choice)) {
			System.out.println("Yes, " + con_choice + " is present in the expense list.\n");
		} else {
			System.out.println("No, " + con_choice + " is not present in the expense list.\n");
		}
