package threadBankProject.seed.trnx;

import threadBankProject.seed.account.Account;
import threadBankProject.seed.customer.Customer;
import threadBankProject.seed.exception.InsufficientBalanceException;
import threadBankProject.seed.exception.UnAuthorizedWithdrawTransactionException;
import threadBankProject.seed.security.Security;

/**
 * <h3>Description :</h3> This class is used to perform the withdrawal
 * trasaction in the Seed Bank
 * 
...
public class WithdrawTransaction extends Security implements Runnable {
	...
	/**
	 * <h3>Description :</h3> The parameterized constructor is used to initialize
	 * the object
	 * 
	 * @param transactionId
	 *            the transaction id of the transaction
	...
	/**
	 * <h3>Description :</h3> This method does the withdrawal from the account
	 * 
	 * @param account
	 *            the account from which the withdrawal has to be done
	 * @param amount
	 *            the amount that has to be withdrawn
	 * @return the remaining balance in the account
	 * @throws InsufficientBalanceException
	 *             This exception is thrown if there is insufficient balance in the
	 *             account
	 */
	...
	/**
	 * <h3>Description :</h3> This method does the job in the thread
	 */
	public void run() {
		try {
			...
			System.out.println(
					transactionId + " transaction " + " failed!!! and your account has insufficient" + "balance");
		}
	}
}
