...
public class DepositTransaction extends Thread {
	...
	/**
	 * <h3>Description :</h3>The parameterized constructor for initializing the
	 * object
	 * 
	 * @param transactionId
	 *            the transaction id for the transaction
	 * @param account
	 *            the account to which the amount has to be deposited
	 * @param customerId
	 *            the customer id of the customer depositing the amount
	 * @param amount
	...
	/**
	 * <h3>Description :</h3>This method deposits the amount into the given Account
	 * 
	 * @param account
	 *            the account to which the amount has to be deposited
	 * @param amount
	...
	/**
	 * <h3>Description :</h3> This method contains job for the thread
	 */
	public void run() {
		// depositing the amount deposit(account, amount);
		// displaying the success message
		System.out.println("Transaction #" + transactionId +  " completed!!! Customer #" + customerId + ", thank you for "
